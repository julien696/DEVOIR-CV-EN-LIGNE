    ...
    return(
        <>
         <header>
                <Navbar />
                <div>
                    <img src="../public/img/banner-mobile.jpg" alt="banner théme bleu et lumiére" className="image"/>
                </div>
           </header>
           <main>
                <div className="d-flex flex-column justify-content-center align-items-center my-5">
                    <h2 className="fs-1 px-5 text-center">MON OFFRE DE SERVICES</h2>
                    <span className="fs-3 text-center px-2">Voici les prestations sur lesquelles je peux intervenir.</span>
                </div>
                <div>
                    <section>
